    ...
    try {
      ...
      request.files.add(
        http.MultipartFile.fromBytes(
          ...
          audioBytes,
          filename:
              'audio.wav', // Filename needed for backend to detect type extension
        ),
      );
      ...
      if (mounted) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text('Error transcribing audio: $e')));
      }
    } finally {
      if (mounted) {
        setState(() {
  ...
  Widget _buildMessageItem(ChatMessage message) {
    return Padding(
      padding: const EdgeInsets.symmetric(
        vertical: 8.0,
        horizontal: 16.0,
      ), // Added horizontal padding for cleaner look
      child: Column(
                    ...
                    child: _isRecording
                        ? VoiceInputWidget(
                            ...
                            onCompleted: (audioBytes) {
                              ...
                              debugPrint(
                                "Voice recording completed. Bytes: ${audioBytes.length}",
                              );
                                    ...
                                    InkWell(
                                      ...
                                      child: Container(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              modelDisplayName(_selectedModel),
                                              style: GoogleFonts.inter(
                                                color: Colors.white,
                                                fontSize: 13,
                                                fontWeight: FontWeight.w500,
                                    ...
                                    if (_textController.text.trim().isEmpty)
                                      Container(
                                        ...
                                        decoration: const BoxDecoration(
                                          color: Colors
                                              .black, // or Color(0xFF1E1E1E) for consistency
                                          shape: BoxShape.circle,
                                        ),
                                        child: IconButton(
                                          onPressed: _isTyping
